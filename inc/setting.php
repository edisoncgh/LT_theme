...
if(is_admin()){
	...
	array(
		...
		'id' => 'LT_git',
		'type' => 'text',
		'desc' => '会以GitHub Corner的形式展示在网站右上角'
	),
	array(
		'name' => '友链页面链接',
		'id' => 'LT_fri',
		'type' => 'text',
		'desc' => '页首菜单栏“友链”所指向的页面，url形式填写'
	),
	array(
		'name' => '归档页面链接',
		'id' => 'LT_arc',
		'type' => 'text',
		'desc' => '页首菜单栏“归档”所指向的页面，url形式填写'
	),
	array(
		'name' => '关于页面链接',
		'id' => 'LT_about',
		'type' => 'text',
		'desc' => '页首菜单栏“关于”所指向的页面，url形式填写'
	),
	array(
		'name' => '备案信息',
		'id' => 'LT_beian',
		'type' => 'text',
		'desc' => '博客的工信部备案信息，不填写则不展示'
	),
	array(
		'name' => '网站图标url',
		'id' => 'LT_ico',
		'type' => 'text',
		'desc' => '网站标签页左边的图标，以url链接形式填写'
	),
	array(
    ...
    function git_add_theme_options_page() {
        ...
        add_theme_page('LT主题设置', 'LT主题设置', 'edit_theme_options', basename(__FILE__) , 'git_options_page');
    }
    ...
    <form method="post">
    <p>
        <input name="reset" type="submit" class="button button-secondary" value="重置选项" onclick="return confirm('您确定要重置选项吗？重置之后您的全部设置将被清空，请您慎重考虑. ');"/>
